...
class OrientationNode(object):
    ...
    def process_image(self, msg, msg_mask):
        ...
        th3 = cv2.adaptiveThreshold(img_c,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,\
              cv2.THRESH_BINARY,11,2)
        # #_,bw = cv2.threshold(img_c, 0, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
        img_c = cv2.bitwise_not(th3)
        ...
        img_debug[y1:y3, x1:x3] = (0,127, 0)

        img_edge_[y1:y2, x1:x2] = (0,0, 127)
        img_edge_[y1:y3, x1:x3] = (0,127, 0)
